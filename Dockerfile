...
RUN apt-get update && apt-get install -y git zlibc zlib1g-dev zlib1g libmemcached-dev libfreetype6-dev libjpeg62-turbo-dev libmcrypt-dev libpng12-dev libicu-dev pkg-config openssl libssl-dev libfontconfig fontconfig ttf-mscorefonts-installer fondu libmemcached11 libmemcachedutil2 build-essential libz-dev\
